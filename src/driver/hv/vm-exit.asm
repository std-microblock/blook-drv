...
guest_context struct
  ...
  $mxcsr dword ?
  dword ? ; align SSE area at offset C0h
...
extern ?fatal_root_error@hv@@YAXXZ : proc
...
?vm_exit@hv@@YAXXZ proc
  ...
  stmxcsr guest_context.$mxcsr[rsp]
  ...
  ldmxcsr guest_context.$mxcsr[rsp]
  ...
  vmresume
  sub rsp, 20h
  call ?fatal_root_error@hv@@YAXXZ
